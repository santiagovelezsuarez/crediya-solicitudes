...
@Slf4j
@Repository
public class ClienteReactiveRepositoryAdapter
        extends ReactiveAdapterOperations<Cliente, ClienteEntity, UUID, ClienteReactiveRepository>
    ...
    private static void logFound(Cliente cliente) {
        log.trace("Cliente encontrado: {}", cliente);
    }
}
